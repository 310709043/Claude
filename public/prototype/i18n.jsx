/* i18n — 中英韓日 strings + simple useT hook */
(function () {
  const STR = {
    // Common
  ...
  const LANG_LABEL = { zh: '中文', en: 'EN', ko: '한국', ja: '日本' };
  const LANG_FULL = { zh: '中文', en: 'English', ko: '한국어', ja: '日本語' };

  function tFor(lang) {
    return function t(key, arg) {
      const entry = STR[key];
      if (!entry) return key;
  ...
  Object.assign(window, { LANGS, LANG_LABEL, LANG_FULL, tFor, I18N: STR });
})();
